...
const COMMON = (name, dot, dotShort) => [
  ...
  [`Watch live ${name} traffic cameras on one map — ${dot} highway and road cameras, each tagged with route and mile marker. See the road before you drive it. Free, no account.`,
   `Mira las cámaras de tráfico de ${name} en vivo en un solo mapa: cámaras de carretera de ${dot}, cada una con su ruta y su marcador de milla. Ve la carretera antes de salir. Gratis, sin cuenta.`],
  [`Watch live ${name} traffic cameras on one map — ${dot} freeway and highway cameras across the metro, each tagged with route and mile marker. See traffic before you leave. Free, no account.`,
   `Mira las cámaras de tráfico de ${name} en vivo en un solo mapa: cámaras de ${dot} en las autopistas del área metropolitana, cada una con su ruta y su marcador de milla. Ve el tráfico antes de salir. Gratis, sin cuenta.`],
  ...
  [`See the actual road before you drive it. Live ${dot} highway cameras across ${name} on one map, each tagged with its route and mile marker. Free, no account — tap any camera for the latest image.`,
   `Ve la carretera de verdad antes de manejar por ella. Cámaras de ${dot} en las carreteras de ${name}, en un solo mapa, cada una con su ruta y su marcador de milla. Gratis, sin cuenta: toca cualquier cámara para ver la imagen más reciente.`],
  [`See ${name} traffic before you leave. Live ${dot} freeway cameras across the metro on one map, each tagged with its route and mile marker. Free, no account — tap any camera for the latest image.`,
   `Ve el tráfico de ${name} antes de salir. Cámaras de ${dot} en las autopistas del área metropolitana, en un solo mapa, cada una con su ruta y su marcador de milla. Gratis, sin cuenta: toca cualquier cámara para ver la imagen más reciente.`],
  ...
  [`Yes. ${dot} publishes its traffic cameras publicly, and MileCheck puts them on one map for free — no account, no sign-up. To have the nearest camera follow you as you drive, the <a href="${APP}" target="_blank" rel="noopener">MileCheck app</a> does it hands-free on CarPlay and Android Auto.`,
  ...
  [`Yes. ${dot} publishes its traffic cameras publicly, and MileCheck puts the ${name} ones on one map for free — no account. To have the nearest camera follow you as you drive, the <a href="${APP}" target="_blank" rel="noopener">MileCheck app</a> does it hands-free on CarPlay and Android Auto.`,
  ...
  [`MileCheck shows the nearest camera and your exact mile marker in real time as you drive ${name}'s highways, plus live DOT alerts on your route. Free to start, works offline, runs on CarPlay and Android Auto.`,
  ...
  [`MileCheck shows the nearest camera and your exact mile marker in real time as you drive around ${name}, plus live DOT alerts on your route. Free to start, works offline, runs on CarPlay and Android Auto.`,
