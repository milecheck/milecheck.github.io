...
fetch(WORKER+'/cameras?state='+CODE).then(r=>r.json()).then(d=>{
  ...
  draw();
}).catch(()=>{document.getElementById('coStatus').textContent='Live cameras unavailable right now — try again shortly.';});
</script>
