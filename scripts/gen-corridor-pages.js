...
const CORRIDORS = [
  {
    ...
    segs: [
      ['I-5 in Washington', `From the Columbia River at Vancouver north through Kelso, Olympia, Joint Base Lewis-McChord (a chronic congestion choke point), Tacoma, Seattle, and Everett up to the Peace Arch crossing at Blaine, at the British Columbia border (see <a href="/drive-into-canada/">driving into Canada</a> and <a href="/borders/">border wait times</a>). Snow is rare at sea level, but the Seattle–Tacoma stretch is one of the most congested corridors in the country — the cameras here are mostly about traffic, not weather.`],
  ...
  <div class="co-wrap">
    <div style="position:relative;">
      ...
      <div class="co-layers" role="group" aria-label="Map layers">
        ...
        <label class="co-layer"><input type="checkbox" id="tgPoi" checked><span class="co-sw poi"></span><span class="co-dot" style="background:#7C3AED"></span>Passes &amp; summits</label>
      </div>
